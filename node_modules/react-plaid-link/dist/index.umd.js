(function (global, factory) {
  ...
  var createPlaid = function createPlaid(options) {
    ...
    console.log(config);
    state.plaid = window.Plaid.create(config); // Keep track of Plaid DOM instance so we can clean up it for them.
    // It's reasonably safe to assume the last plaid iframe will be the one
    // just created by the line above.

    state.iframe = document.querySelector('iframe[id^="plaid-link-iframe-"]:last-child');
